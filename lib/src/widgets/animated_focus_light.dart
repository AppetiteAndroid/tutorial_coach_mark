...
abstract class AnimatedFocusLightState extends State<AnimatedFocusLight> with TickerProviderStateMixin {
  ...
  void _runFocus() {
    ...
    _controller.duration =
        _targetFocus.unFocusAnimationDuration ?? widget.unFocusAnimationDuration ?? _targetFocus.focusAnimationDuration ?? widget.focusAnimationDuration ?? defaultFocusAnimationDuration;
    _controller.forward();
  }
  ...
  Widget _getLightPaint(TargetFocus targetFocus, {double left = 0, double top = 0, double width = 0, double height = 0}) {
      ...
      return Stack(
        children: [
          ...
          Positioned(
            ...
            top: top,
            child: Listener(
              behavior: _targetFocus.enableTargetTab ? HitTestBehavior.translucent : HitTestBehavior.opaque,
  ...
  SizedBox _getSizedPainter(TargetFocus targetFocus) {
    return SizedBox(
      ...
      child: CustomPaint(
        foregroundPainter: _getPainter(targetFocus),
      ),
    );
  }
  ...
  BorderRadius _betBorderRadiusTarget() {
    double radius = _targetFocus.shape == ShapeLightFocus.Circle ? _targetPosition?.size.width ?? borderRadiusDefault : _targetFocus.radius ?? borderRadiusDefault;
